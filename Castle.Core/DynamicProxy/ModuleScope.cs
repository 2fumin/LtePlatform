...
namespace Castle.DynamicProxy
{
	...
	public class ModuleScope
	{
		...
		public ModuleScope(bool savePhysicalAssembly, bool disableSignedModule = false)
			: this(
		...
		public ModuleBuilder ObtainDynamicModuleWithWeakName()
		{
			lock (moduleLocker)
			{
			    return WeakNamedModule ?? (WeakNamedModule = CreateModule(false));
			}
		}
		...
		private ModuleBuilder CreateModule(bool signStrongName)
		{
			...
			if (savePhysicalAssembly)
			{
				...
				catch (ArgumentException e)
				{
					...
					var message =
					    $"There was an error creating dynamic assembly for your proxies - you don't have permissions required to sign the assembly. To workaround it you can enforce generating non-signed assembly only when creating {GetType()}. ALternatively ensure that your account has all the required permissions.";
...
#if !SILVERLIGHT
		    if (!signStrongName) return assemblyName;
		...
		public string SaveAssembly()
		{
			...
			return WeakNamedModule != null ? SaveAssembly(false) : null;
		}
		...
		public void LoadAssemblyIntoCache(Assembly assembly)
		{
			...
			{
				var message =
				    $"The given assembly '{assembly.FullName}' does not contain any cache information for generated types.";
