...
function add_sector(centre, irotation, iangle) {
    var assemble = new Array();
    var dot;

    var angle = Math.PI / 180 * iangle;
    var rotation = Math.PI / 180 * irotation;


    var t = 0;
    var r = getRadius().rSector;
...
function getPosition(centre, r, angle) {
