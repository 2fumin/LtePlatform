...
namespace Castle.Core.Test.Main
{
	...
	public class XmlConfigurationDeserializerTests
	{
		...
		{
			var result = Configuration.Xml.XmlConfigurationDeserializer.GetConfigValue("\t");
		...
		public void Tab_character_is_not_trimmed_from_config_value_XML()
		{
			...
			var result = Configuration.Xml.XmlConfigurationDeserializer.GetDeserializedNode(node);
