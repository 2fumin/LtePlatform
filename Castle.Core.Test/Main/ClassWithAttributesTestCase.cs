...
namespace Castle.Core.Test.Main
{
	...
	public class ClassWithAttributesTestCase : BasePEVerifyTestCase
	{
		...
		public void EnsureProxyHasAttributesOnClassAndMethods()
		{
			...
			var attributes = instance.GetType().GetCustomAttributes(typeof (NonInheritableAttribute), false);
		...
		public void EnsureProxyHasAttributesOnClassAndMethods_ComplexAttributes()
		{
			...
			var attributes = instance.GetType().GetCustomAttributes(typeof (ComplexNonInheritableAttribute), false);
			Assert.AreEqual(1, attributes.Length);
