...
namespace Castle.Core.Test.Components.Xml
{
#if !SILVERLIGHT
	...
	public class XmlAdapterAcceptanceTestCase
	{
		...
		{
			const string line1 = "2922 South Highway 205";
			const string city = "Rockwall";
			const string state = "TX";
			const string zipCode = "75032";
		    ...
		    if (line1Node != null) line1Node.InnerText = "1234 Tulip";
		...
		public void Adapter_OnXml_CanReadProperties()
		{
			...
			var xml =
			    $@"<Season xmlns='RISE' xmlns:rise='RISE'>
					 ...
					 <StartsOn>{
			        XmlConvert.ToString(startsOn, XmlDateTimeSerializationMode.Local)}</StartsOn>
					 <EndsOn>{
			        XmlConvert.ToString(endsOn, XmlDateTimeSerializationMode.Local)
					 ...
					 <League>
						<Team Name='{team1Name}'>
						   <AmountDue>{
			        XmlConvert.ToString(team1Balance)}</AmountDue>
						   <Roster>
							  <Participant FirstName='{
			        team1Player1FirstName}' lastName='{team1Player1LastName
			        }'>
							  </Participant>
							  <Participant FirstName='{team1Player2FirstName}' lastName='{
			        team1Player2LastName}'>
						...
						<Team Name='{
			        team2Name}'>
						   <AmountDue>{XmlConvert.ToString(team2Balance)
			        }</AmountDue>
						   <Roster>
							  <Participant FirstName='{team2Player1FirstName}' lastName='{
