...
namespace AutoMapper.Should
{
    ...
    public static class ObjectAssertExtensions
    {
        ...
        {
            CustomizeAssert.GreaterThan(@object, value);
        }
        ...
        {
            CustomizeAssert.GreaterThan(@object, value, comparer);
        }
        ...
        {
            CustomizeAssert.GreaterThanOrEqual(@object, value);
        }
        ...
        {
            CustomizeAssert.GreaterThanOrEqual(@object, value, comparer);
        }
        ...
        {
            CustomizeAssert.LessThan(@object, value);
        }
        ...
        {
            CustomizeAssert.LessThan(@object, value, comparer);
        }
        ...
        {
            CustomizeAssert.LessThanOrEqual(@object, value);
        }
        ...
        {
            CustomizeAssert.LessThanOrEqual(@object, value, comparer);
        }
